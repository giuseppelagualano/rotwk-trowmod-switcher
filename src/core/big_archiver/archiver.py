...
from core.big_archiver.costants import DEFAULT_ARTS_ARCHIVE_NAME, DEFAULT_DATA1_ARCHIVE_NAME, DEFAULT_INI_ARCHIVE_NAME, DEFAULT_ITLANG_ARCHIVE_NAME
...
def create_big_archives(source_content_path: str, game_path: str, logger: logging.Logger) -> bool:
    ...
    archive_operations = [
        ...
        (create_trowmod_itlang_big_archive, {'archive_name': DEFAULT_ITLANG_ARCHIVE_NAME}),
        (create_trowmod_data1_big_archive, {'archive_name': DEFAULT_DATA1_ARCHIVE_NAME}),
